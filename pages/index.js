...
async function main () {
  ...
  const host = prompt('Host', 'game3.falixserver.net')
  const port = parseInt(prompt('Port', '18674'))
  const username = prompt('Username', 'BOT')
  ...
  bot.once('spawn', () => {
    bot.chat('/l ADOLF12344gaef')
    bot.chat('/setidletimeout 0')
    console.log('IM SPAWNED')
